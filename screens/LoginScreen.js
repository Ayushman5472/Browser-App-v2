...
import {Text, TouchableOpacity, View, TextInput, StyleSheet, ScrollView, Modal, KeyboardAvoidingView, Alert} from 'react-native'
...
render(){
    return(
        <View style = {styles.container}>
            ...
            <TouchableOpacity style={styles.touchableOpacity} onPress={()=>{this.userLogin(this.state.emailId,this.state.password)}}><Text style={styles.text}>Enter!</Text></TouchableOpacity>
            <TouchableOpacity style={styles.TouchableOpacity} onPress={this.state.isModalVisible=true}><Text>Sign Up</Text></TouchableOpacity>
        </View>
    )
